...
class ClinicalRecordFieldOption extends Model {
    /**
     * Table in database.
     *
     * @var string
     */
    protected $table = "clinical_record_field_option";
     ...
     * @var string
     */
    protected $primaryKey = "clinical_record_field_option_id";
     ...
     */
    protected $casts = [
        "clinical_record_field_option_id" => "integer",
